    ...
    "/../../jshint/node_modules/underscore/underscore.js": [function (_dereq_, module, exports) {
      (function (global) {
        (function (global, factory) {
          _typeof(exports) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define('underscore', factory) : function () {
          ...
          var root = (typeof self === "undefined" ? "undefined" : _typeof(self)) == 'object' && self.self === self && self || _typeof(global) == 'object' && global.global === global && global || Function('return this')() || {};
          var ArrayProto = Array.prototype,
    ...
    "/../../jshint/src/jshint.js": [function (_dereq_, module, exports) {
      ...
      var JSHINT = function () {
        ...
        function propertyName(context, preserveOrToken) {
          ...
          if (_typeof(preserveOrToken) === "object") {
            id = preserveOrToken;
          } else {
          ...
          if (_.includes(["in", "of"], nextop.value)) {
            ...
            if (nextop.value === "in" && state.option.forin) {
              if (state.forinifchecks && state.forinifchecks.length > 0) {
                ...
                s && s.length > 0 && (_typeof(s[0]) !== "object" || s[0].value !== "if") || check.type === "(positive)" && s.length > 1 || check.type === "(negative)") {
                  warning("W089", this);
                }
              }
        ...
        var itself = function itself(s, o, g) {
          ...
          function each(obj, cb) {
            if (!obj) return;
            if (!Array.isArray(obj) && _typeof(obj) === "object") obj = Object.keys(obj);
            obj.forEach(cb);
          }
      ...
      if (_typeof(exports) === "object" && exports) {
      ...
      Lexer.prototype = {
        ...
        scanNumericLiteral: function scanNumericLiteral(checks) {
          ...
          if (_char2 !== ".") {
            ...
            while (index < length) {
              ...
              if (!(isLegacy && isDecimalDigit(_char2)) && !isAllowedDigit(_char2)) {
                break;
              }
        ...
        scanRegExp: function scanRegExp(checks) {
          ...
          var scanRegexpEscapeSequence = function () {
            ...
            if (reg.nonzeroDigit.test(_char5)) {
              sequence = _char5;
            ...
            } else if (_char5 === "0" && reg.decimalDigit.test(this.peek(index + 1))) {
              this.triggerAsync("error", {
                code: "E016",
                line: this.line,
                character: this["char"],
          ...
          while (index < length) {
            ...
            if (_char5 === "{" && !hasInvalidQuantifier) {
